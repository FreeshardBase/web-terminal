<template>
  <b-modal
    ...
    <p>
      Your shard offers a variety of apps for many different use cases.
    ...
    <usage-prompt-card
      ...
      Keep your passwords on Shard, securely encrypted with your master password.
    ...
    <usage-prompt-card
      ...
      Replace your filing cabinet with Shard.
    ...
    <usage-prompt-card
      ...
      Upload your MP3 collection to Shard and listen to it from anywhere.
    ...
    <usage-prompt-card
      ...
      Store and organize your bookmarks on Shard.
